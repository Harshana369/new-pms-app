...
export const mobitelHandOverProjectsReducer = (
  state = { mobitelHandOverProjectsData: [] },
  action
) => {
  switch (action.type) {
    case MOBITEL_HANDOVER_DATA_SUCCESS:
      return { mobitelLastUpdateLoading: true, mobitelHandOverProjectsData: [] };
    case MOBITEL_LAST_UPDATE_SUCCESS:
      return { mobitelLastUpdateLoading: false, mobitelLastUpdateData: action.payload };
    case MOBITEL_LAST_UPDATE_FAIL:
      return { mobitelLastUpdateLoading: false, error: action.payload };
